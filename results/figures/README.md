...
| 4 | `figure4/` | SIMPER fingerprints (a), lipid-class heatmap (b), redundancy (c) | `r/fig4.R`; plotted CSVs in `r/data/` | Panel b uses the **full atlas** as denominator. Display labels: Viridiplantae, Protists |
| 5 | `figure5/` | ClimGrass composition (a) + treatment effects (b) | `r/fig5_final.R`; plotted CSVs in `r/data/`; legend in `figure5/LEGEND.md` | Two estimators (fc-weighted bars, marker-panel diamonds). Animalia ≈ 14.7 % lies above the literature range. No omnibus *q* < 0.05; Pseudomonadota drought *q* = 0.08 / qSIP 0.005. Display labels: Viridiplantae, Protists |

...
false-positive sink (Viridiplantae-to-Archaea 23%, Bacteria-to-Archaea 17%). **b**,
...
isolates (130/164), and for every group except Viridiplantae and Animalia the
correction raises self-recovery (Bacteria 63 to 79%, Fungi 48 to 69%,
Protists 51 to 59%). **c**, Per-group self-recovery, uncorrected versus corrected.
...
estimator recovers poorly are recovered well (Viridiplantae 47 to 95%, Animalia 47 to

...
| 3 | `figure3/` | Dendrograms, lipidome–phylogeny Mantel, similarity heatmaps | `figure3_strict_composite_review_only.R` (assembles the three R-rendered panels). Plotted CSVs in `figure3/r/data/`. Tree + accessions in `methods/09_phylogeny/` | 16 phyla / 120 pairs; Mantel r = 0.509 (POS) / 0.553 (NEG) against SSU v3 patristic distance. Panels 3a and 3c are lipids only. Table S15 is **not** the 3b x-axis |

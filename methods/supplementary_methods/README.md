...
| SM | Topic | Repository folder | Values in this analysis |
|---|---|---|---|
...
| SM3 | Annotation pipeline (11 steps) | [`../04_annotation/`](../04_annotation/) | 6,360 POS / 1,889 NEG annotated; SIRIUS 8,004 formulas (70.4%) / 7,336 CANOPUS / 7,199 CSI |
| SM4 | Fingerprint extraction & cross-method validation | [`../06_fingerprints/`](../06_fingerprints/) (`cross_method/`) | 45,525-feature substrate, 164 samples, 16 phyla; LOO baseline 64.6% |
...
| SM8 | Quantification correction & expected composition | [`../08_climgrass/`](../08_climgrass/) | Rule A (out-of-window RIE → uncalibrated 1.0); literature expectation ranges in Table S6 |
